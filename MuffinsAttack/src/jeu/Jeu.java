...
/**
 * Cette classe est un exemple d'interface de jeu. Elle étend DevintFrame pour
 * avoir un Frame et r�agir aux événements claviers Implémente ActionListener
 * pour réagir au clic souris sur le bouton. On surchage la méthode "keyPressed"
 * pour associer une action à la touche F3
 *
 * @author helene
 *
 */
public class Jeu extends FenetreAbstraite implements ActionListener {
    ...
    protected void init() {
        ...
        // c'est l'objet Jeu lui-même qui r�agit au clic souris
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        voix.stop();
        // on récupère la source de l'événement
    ...
    public void keyPressed(KeyEvent e) {
        // appel à la méthode mère qui gère les événements ESC, F1, F3, F4
        super.keyPressed(e);
